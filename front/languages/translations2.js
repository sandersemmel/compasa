...
export let translations = {
    ...
    "fi" : {
        "STEP1_CARDTITLE": "Jaa elämäsi lukuihin",
        "STEP1_CARDTEXT": "Ole hyvä ja jaa elämäsi 7 osaan. Esimerkki luvusta voisi olla ensimmäinen vuosi koulussa, ensimmäinen työpaikka, suhde",
        "input1": "Kirjoita ensimmäinen luku tähän...",
        "input2": "Kirjoita toinen luku tähän...",
        "input3": "Kirjoita kolmas lukusi tähän...",
        "input4": "Kirjoita neljäs lukusi tähän...",
        "input5": "Kirjoita viides lukusi tähän...",
        "input6": "Kirjoita kuudes lukusi tähän...",
        "input7": "Kirjoita seitsemäs lukusi tähän...",
        "STEP1_BUTTON": "Tallenna & Seuraava",
        "STEP2_CARDTEXT": "Kuvaile yksityiskohtaisesti tärkeitä kokemuksia, joita sinulle tapahtui tämän elämäsi luvun aikana. Se voi olla positiivinen tai negatiivinen kokemus. Anna jokaiselle kokemukselle otsikko ja kuvaus. Yritä keskittyä vain itse kokemukseen.",
        "STEP2_BUTTON": "Tallenna luku",
        "input1fields1textareatitle1": "Ensimmäisen kokemuksen otsikko...",
        "input1fields1textarea1": "Kuvaus ensimmäisestä kokemuksesta...",
        ...
        "input1fields1textareatitle4": "Neljäs kokemuksen otsikko...",
        "input1fields1textarea4": "Kuvaus neljännestä kokemuksesta...",
        "input1fields1textareatitle5": "Viides kokemus otsikko...",
        "input1fields1textarea5": "Kuvaus viidennestä kokemuksesta...",
        "input1fields1textareatitle6": "Kuudes kokemustitteli...",
        "input1fields1textarea6": "Kuvaus kuudennesta kokemuksesta...",
        "input1fields1textareatitle7": "Seitsemäs kokemuksen otsikko...",
        "input1fields1textarea7": "Kuvaus seitsemännestä kokemuksesta...",
        "input2fields2textareatitle1": "Ensimmäisen kokemuksen otsikko...",
        "input2fields2textarea1": "Kuvaus ensimmäisestä kokemuksesta...",
        ...
        "input2fields2textareatitle4": "Neljäs kokemuksen otsikko...",
        "input2fields2textarea4": "Kuvaus neljännestä kokemuksesta...",
        "input2fields2textareatitle5": "Viides kokemus otsikko...",
        "input2fields2textarea5": "Kuvaus viidennestä kokemuksesta...",
        "input2fields2textareatitle6": "Kuudes kokemustitteli...",
        "input2fields2textarea6": "Kuvaus kuudennesta kokemuksesta...",
        "input2fields2textareatitle7": "Seitsemäs kokemuksen otsikko...",
        "input2fields2textarea7": "Kuvaus seitsemännestä kokemuksesta...",
        "input3fields3textareatitle1": "Ensimmäisen kokemuksen otsikko...",
        "input3fields3textarea1": "Kuvaus ensimmäisestä kokemuksesta...",
        ...
        "input3fields3textareatitle4": "Neljäs kokemuksen otsikko...",
        "input3fields3textarea4": "Kuvaus neljännestä kokemuksesta...",
        "input3fields3textareatitle5": "Viides kokemus otsikko...",
        "input3fields3textarea5": "Kuvaus viidennestä kokemuksesta...",
        "input3fields3textareatitle6": "Kuudes kokemustitteli...",
        "input3fields3textarea6": "Kuvaus kuudennesta kokemuksesta...",
        "input3fields3textareatitle7": "Seitsemäs kokemuksen otsikko...",
        "input3fields3textarea7": "Kuvaus seitsemännestä kokemuksesta...",
        "input4fields4textareatitle1": "Ensimmäisen kokemuksen otsikko...",
        "input4fields4textarea1": "Kuvaus ensimmäisestä kokemuksesta...",
        ...
        "input4fields4textareatitle4": "Neljäs kokemuksen otsikko...",
        "input4fields4textarea4": "Kuvaus neljännestä kokemuksesta...",
        "input4fields4textareatitle5": "Viides kokemus otsikko...",
        "input4fields4textarea5": "Kuvaus viidennestä kokemuksesta...",
        "input4fields4textareatitle6": "Kuudes kokemustitteli...",
        "input4fields4textarea6": "Kuvaus kuudennesta kokemuksesta...",
        "input4fields4textareatitle7": "Seitsemäs kokemuksen otsikko...",
        "input4fields4textarea7": "Kuvaus seitsemännestä kokemuksesta...",
        "input5fields5textareatitle1": "Ensimmäisen kokemuksen otsikko...",
        "input5fields5textarea1": "Kuvaus ensimmäisestä kokemuksesta...",
        ...
        "input5fields5textareatitle4": "Neljäs kokemuksen otsikko...",
        "input5fields5textarea4": "Kuvaus neljännestä kokemuksesta...",
        "input5fields5textareatitle5": "Viides kokemus otsikko...",
        "input5fields5textarea5": "Kuvaus viidennestä kokemuksesta...",
        "input5fields5textareatitle6": "Kuudes kokemustitteli...",
        "input5fields5textarea6": "Kuvaus kuudennesta kokemuksesta...",
        "input5fields5textareatitle7": "Seitsemäs kokemuksen otsikko...",
        "input5fields5textarea7": "Kuvaus seitsemännestä kokemuksesta...",
        "input6fields6textareatitle1": "Ensimmäisen kokemuksen otsikko...",
        "input6fields6textarea1": "Kuvaus ensimmäisestä kokemuksesta...",
        ...
        "input6fields6textareatitle4": "Neljäs kokemuksen otsikko...",
        "input6fields6textarea4": "Kuvaus neljännestä kokemuksesta...",
        "input6fields6textareatitle5": "Viides kokemus otsikko...",
        "input6fields6textarea5": "Kuvaus viidennestä kokemuksesta...",
        "input6fields6textareatitle6": "Kuudes kokemustitteli...",
        "input6fields6textarea6": "Kuvaus kuudennesta kokemuksesta...",
        "input6fields6textareatitle7": "Seitsemäs kokemuksen otsikko...",
        "input6fields6textarea7": "Kuvaus seitsemännestä kokemuksesta...",
        "input7fields7textareatitle1": "Ensimmäisen kokemuksen otsikko...",
        "input7fields7textarea1": "Kuvaus ensimmäisestä kokemuksesta...",
        ...
        "input7fields7textareatitle4": "Neljäs kokemuksen otsikko...",
        "input7fields7textarea4": "Kuvaus neljännestä kokemuksesta...",
        "input7fields7textareatitle5": "Viides kokemus otsikko...",
        "input7fields7textarea5": "Kuvaus viidennestä kokemuksesta...",
        "input7fields7textareatitle6": "Kuudes kokemustitteli...",
        "input7fields7textarea6": "Kuvaus kuudennesta kokemuksesta...",
        "input7fields7textareatitle7": "Seitsemäs kokemuksen otsikko...",
        "input7fields7textarea7": "Kuvaus seitsemännestä kokemuksesta...",
        "STEP3_BUTTON": "Tallenna vaikutus",
        "EXPLANATION_CARD_TITLE": "Miten tämä kokemus on vaikuttanut sinuun?",
        "EXPLANATION_CARD_TEXT": "Millä tavoin tämä kokemus on muokannut sinua sellaiseksi kuin olet tänään? Miten suhtaudut muihin ihmisiin tämän jälkeen? Miten sinä näet maailman?",
        "STEP4_BUTTON": "Jatka analyysiin",
        "STEP4_CARDTITLE": "Mitkä ovat kriittisimmät elämäkokemuksesi?",
        "STEP4_CARDTEXT": "Valitse 10 kokemusta, jotka olivat tärkeimpiä muotoiltaessasi sitä, kuka olet tänään.",
        "FIRST_STEP_TITLE": "Kokemusta pohdiskelemassa",
        "FIRST_STEP_TEXT": "Oliko tämä positiivinen vai negatiivinen kokemus? Miten se tapahtui? Satutivatko tai auttoivatko muut sinua? Mikä rooli sinulla oli tapahtumissa, jotka johtivat tähän kokemukseen? Oliko jotain, mitä sinun olisi pitänyt tehdä toisin? Oliko jotain, mitä et voinut hallita, tai jotain, joka oli ymmärryksesi ulkopuolella tuolloin?",
        "SECOND_STEP_TITLE": "Analysoi persoonallisuutta",
        "SECOND_STEP_TEXT": "Vaikuttiko tämä luottamuksesi muihin ihmisiin? Vaikuttiko se tulevaisuuden toiveisiisi? Vaikuttiko se uskoon omaan arvoonsa ja elämän arvoon? Onko se vaikuttanut persoonaasi?",
        "STEP5_BUTTON": "Tallenna analyysi",
        "STEP5_TEXT_AREA": "Kirjoita analyysisi tähän...",
        "STEP6_CARDTITLE": "Hyvin tehty! Sinun pitäisi olla erittäin ylpeä itsestäsi.",
        "STEP6_CARDTEXT": "Kirjoituksesi vaikutukset voivat kestää hetken, ennen kuin ne näkyvät täysin. Huono olo kirjoittamisen jälkeen on täysin normaalia. Olet tehnyt valtavan työn menneisyytesi läpi, eikä se ole helppo tehtävä. Sinun pitäisi alkaa tuntea positiivisia hyötyjä kahden viikon kuluttua. Menneet muistosi eivät enää kummittele ja häiritse sinua yhtä paljon etkä tunne kaunaa. Toivomme, että tämä harjoitus auttoi sinua tulemaan paremmaksi ihmiseksi, ansaitset sen. Kun olet alkanut tuntea positiiviset hyödyt, voit jatkaa seuraavaan harjoitukseen.",
        "LARGETEXT": "Paras ilmainen online-terapia",
        "LETSGO_BTN": "Aloita ilmainen terapia",
        "SMALLER_TEXT": "Opi tuntemaan itsesi",
        "SMALLER_TEXT_SUBTEXT": "Tämän harjoituksen tarkoituksena on auttaa sinua kehittämään selkeämpi käsitys menneisyydestäsi kirjoittamalla oma tarinasi.",
        "WHY_BOTHER": "Miksi itsehoitoterapiaa?",
        "WHEN_BAD": "Kun sinulle tapahtuu huonoja asioita, mielesi ja kehosi reagoivat kohtelemalla ympäristöä ikään kuin se olisi vaarallista ja valmistautumalla hätätilanteeseen. Tämä valmistautuminen on stressaavaa ja väsyttää sinua henkisesti ja fyysisesti.",
        "DONT_MAKE_SAME_MISTAKES": "ÄLÄ TOISTA VIRHEITÄ - Jos sinulle on tapahtunut jotain pahaa menneisyydessä, mielesi ei voi olla rauhassa ennen kuin olet keksinyt, kuinka voit välttää saman asian toistumisen tulevaisuudessa.",
        "REMOVE_WEIGHT": "POISTA MENEISTEN PAINO - Jos muistat muistoja, jotka saavat sinut häpeään, syyllisyyteen, vihaiseksi tai loukatuksi, ja nuo muistot ovat yli puolitoista vuotta vanhoja, mielesi ei ole rauhassa. Sinulla on edelleen menneisyyden paino.",
        "STRESS_MANAGEMENT": "STRESSIHALLINTA – Jos tunnistat nämä merkit itsessäsi, henkinen ja fyysinen terveytesi voi olla vaarassa. Kehosi tuottaa kortisolia, kun se havaitsee olevansa vaarassa ja jatkuvasti kohonnut kortisolitaso heikentää immuunijärjestelmää, polttaa energiaa, vahingoittaa muistia ja emotionaalisia kykyjä.",
        "PROMO1": "100 % ilmainen. Ei tarvitse rekisteröityä, ei maksuja.",
        "PROMO2": "100 % yksityinen. Tietoja ei lähetetä millekään palvelimelle. Kaikki tiedot säilytetään laitteessasi.",
        "PROMO3": "100 % Lahjoituksilla toimiva sivusto.",
        "MADE_FOR_YOU": "Paras ilmainen online-terapiatyökalu, jossa on oletuksena tietosuoja.",
        "ARTICLE": "Paras ilmainen online mielenterveysohjelma, joka auttaa selviytymään stressistä",
